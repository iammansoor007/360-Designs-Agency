    ...
    >
      ...
      >
        {numbers.map((num) => (
          <span 
            key={num} 
            className="flex items-center justify-center leading-none bg-clip-text text-transparent bg-gradient-to-r from-[#265C83] to-[#4b4fff] dark:from-[#E9BD36] dark:to-[#FFA800]" 
            style={{ 
              height: "1em",
      ...
      {digits.map((digit, idx) => {
        if (isNaN(Number(digit))) {
          return (
            <span 
              key={idx} 
              className="leading-none bg-clip-text text-transparent bg-gradient-to-r from-[#265C83] to-[#4b4fff] dark:from-[#E9BD36] dark:to-[#FFA800]"
  ...
  return (
    <>
      <main className="flex-1 w-full bg-white dark:bg-[#080710] text-brand-dark dark:text-white transition-colors duration-300 relative overflow-hidden">
        ...
        <div className="absolute top-[3%] left-[-15%] w-[50vw] h-[50vw] rounded-full bg-[#265C83]/[0.03] dark:bg-[#265C83]/[0.06] blur-[120px] pointer-events-none select-none -z-10 animate-float-blob" />
        ...
        <div className="absolute bottom-[30%] left-[-12%] w-[48vw] h-[48vw] rounded-full bg-[#265C83]/[0.02] dark:bg-[#265C83]/[0.04] blur-[140px] pointer-events-none select-none -z-10 animate-float-blob" />
        ...
        <section className="relative overflow-hidden pt-4 pb-4 md:pt-6 md:pb-6 border-b border-brand-zinc-200 dark:border-white/10">
          ...
          {/* Ambient Glows */}
          <div className="absolute top-[10%] left-[-5%] w-[350px] h-[350px] rounded-full bg-[#265C83]/[0.02] dark:bg-[#265C83]/[0.05] blur-[120px] pointer-events-none -z-10" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              ...
              >
                ...
                <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl font-black tracking-tight leading-[1.08] text-brand-dark dark:text-white">
                  We Build Digital <br />
                  Experiences That <br />
                  <span className="relative inline-block text-[#265C83] dark:text-[#E9BD36] pb-2 whitespace-nowrap">
                    Drive Real Growth.
                ...
                <div className="flex flex-wrap items-center gap-4 pt-2">
                  ...
                  >
                    <span className="absolute inset-0 bg-[#E9BD36] dark:bg-[#265C83] translate-x-[-102%] group-hover:translate-x-0 transition-transform duration-500 ease-[cubic-bezier(0.76,0,0.24,1)]" />
                    ...
                    <span className="relative z-10 mr-2 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#080710] dark:bg-white text-white dark:text-[#080710] group-hover:bg-[#080710] dark:group-hover:bg-[#265C83] group-hover:text-[#E9BD36] dark:group-hover:text-white transition-all duration-300">
              ...
              <div className="lg:col-span-6 relative w-full h-[320px] sm:h-[420px] md:h-[480px] lg:h-[520px] flex items-center justify-center pt-8 lg:pt-0">
                ...
                <div className="absolute bottom-[10%] left-[10%] w-[300px] h-[300px] rounded-full bg-[#265C83]/[0.03] dark:bg-[#265C83]/[0.08] blur-[80px] pointer-events-none -z-10" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-stretch">
              ...
              <div className="lg:col-span-4 flex flex-col justify-between self-stretch text-left">
                <div className="w-full">
                  <div className="relative flex items-center justify-between w-full pb-2.5 mb-3">
                    <span className="text-[8px] font-mono tracking-widest text-[#265C83] dark:text-[#E9BD36] font-black uppercase">// SUMMARY</span>
                  ...
                  <h2 className="font-heading text-3xl sm:text-4xl font-black tracking-tight leading-[1.1] text-brand-dark dark:text-white mt-1">
                    We shape the future of digital <span className="text-[#265C83] dark:text-[#E9BD36] italic font-serif font-light">brands.</span>
                  </h2>
                ...
                <div className="pt-6 mt-8 border-t border-brand-zinc-100 dark:border-white/5 w-full select-none">
                  <span className="text-[7.5px] font-mono tracking-widest text-[#265C83] dark:text-[#E9BD36] uppercase font-black block mb-3">
                    // EXPERTISE
                  </span>
              ...
              <div className="lg:col-span-8 grid grid-cols-2 gap-x-12 gap-y-12 sm:gap-x-16 border-t lg:border-t-0 lg:border-l border-brand-zinc-200/60 dark:border-white/5 pt-10 lg:pt-0 lg:pl-16">
                ...
                <div className="flex flex-col items-start relative w-full group hover:-translate-y-1 transition-transform duration-350 ease-out">
                  <div className="relative flex items-center justify-between w-full pb-2.5 mb-3">
                    <Globe className="h-4.5 w-4.5 text-[#265C83] dark:text-[#E9BD36] transition-transform duration-300 group-hover:rotate-[15deg]" />
                    ...
                    <div className="absolute bottom-0 left-0 w-full h-[1px] bg-brand-zinc-100 dark:bg-white/5" />
                    <div className="absolute bottom-0 left-0 w-0 h-[1.5px] bg-[#265C83] dark:text-[#E9BD36] group-hover:w-full transition-all duration-500 ease-out" />
                  </div>
                  <div className="flex items-baseline gap-0.5 text-brand-dark dark:text-white">
                    ...
                    <span className="font-heading font-bold text-2xl sm:text-3xl leading-none text-[#265C83] dark:text-[#E9BD36]">+</span>
                  </div>
                  <p className="text-[10px] sm:text-[11px] font-black text-brand-dark dark:text-white uppercase tracking-widest mt-3.5 leading-none transition-colors duration-300 group-hover:text-[#265C83] dark:group-hover:text-[#E9BD36]">
                    Global Clients
                  </p>
                ...
                <div className="flex flex-col items-start relative w-full group hover:-translate-y-1 transition-transform duration-350 ease-out">
                  <div className="relative flex items-center justify-between w-full pb-2.5 mb-3">
                    <Rocket className="h-4.5 w-4.5 text-[#265C83] dark:text-[#E9BD36] transition-transform duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5" />
                ...
                <div className="flex flex-col items-start relative w-full group hover:-translate-y-1 transition-transform duration-350 ease-out">
                  <div className="relative flex items-center justify-between w-full pb-2.5 mb-3">
                    <Heart className="h-4.5 w-4.5 text-[#265C83] dark:text-[#E9BD36] transition-transform duration-300 group-hover:scale-110" />
                    <span className="text-[8px] font-mono tracking-widest text-brand-zinc-400 dark:text-zinc-500 select-none">[ 03 ]</span>
                    {/* Hover animated border line */}
                    <div className="absolute bottom-0 left-0 w-full h-[1px] bg-brand-zinc-100 dark:bg-white/5" />
                    <div className="absolute bottom-0 left-0 w-0 h-[1.5px] bg-[#265C83] dark:bg-[#E9BD36] group-hover:w-full transition-all duration-500 ease-out" />
                  </div>
                  <div className="flex items-baseline gap-0.5 text-brand-dark dark:text-white">
                    <span className="font-heading font-black text-5xl sm:text-6xl md:text-7xl tracking-tighter leading-none text-brand-dark dark:text-white">
                ...
                <div className="flex flex-col items-start relative w-full group hover:-translate-y-1 transition-transform duration-350 ease-out">
                  <div className="relative flex items-center justify-between w-full pb-2.5 mb-3">
                    <Trophy className="h-4.5 w-4.5 text-[#265C83] dark:text-[#E9BD36] transition-transform duration-300 group-hover:rotate-[-10deg]" />
        ...
        <section className="relative overflow-hidden py-20 md:py-28 border-b border-brand-zinc-200 dark:border-white/10 bg-white dark:bg-[#080710]">
          ...
          <div className="absolute right-[5%] top-[10%] text-[15vw] sm:text-[12vw] font-heading font-black tracking-tighter text-[#265C83]/[0.015] dark:text-white/[0.01] pointer-events-none select-none z-0 leading-none">
            CREATIVE
          </div>
              ...
              <div className="lg:col-span-6 space-y-10 text-left">
                <div className="space-y-4">
                  <div className="flex items-center gap-2 select-none">
                    <span className="text-[8.5px] font-mono tracking-widest text-[#265C83] dark:text-[#E9BD36] font-black uppercase">// WHO WE ARE</span>
                    <div className="h-[1px] w-8 bg-[#265C83]/20 dark:bg-white/10" />
                  </div>
                  ...
                  <h2 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-black text-brand-dark dark:text-white tracking-tight leading-[1.05]">
                    ...
                    not just <span className="text-[#265C83] dark:text-[#E9BD36] italic font-serif font-light">interfaces.</span>
                  </h2>
                ...
                <div className="border-t border-brand-zinc-200 dark:border-white/10 divide-y divide-brand-zinc-200 dark:divide-white/10 w-full">
                  ...
                  <div className="group relative py-6 flex items-start justify-between gap-6 cursor-pointer overflow-hidden transition-all duration-300">
                    ...
                    <div className="flex items-start gap-4 sm:gap-6">
                      <span className="text-[10px] font-mono font-bold text-[#265C83] dark:text-[#E9BD36] mt-1 select-none">[ 01 ]</span>
                      <div className="space-y-1">
                        <h3 className="text-xs sm:text-sm font-black uppercase tracking-wider text-brand-dark dark:text-white group-hover:text-[#265C83] dark:group-hover:text-[#E9BD36] transition-colors duration-300">
                          Radical Aesthetics
                        </h3>
                  ...
                  <div className="group relative py-6 flex items-start justify-between gap-6 cursor-pointer overflow-hidden transition-all duration-300">
                    ...
                    <div className="flex items-start gap-4 sm:gap-6">
                      <span className="text-[10px] font-mono font-bold text-[#265C83] dark:text-[#E9BD36] mt-1 select-none">[ 02 ]</span>
                      <div className="space-y-1">
                        <h3 className="text-xs sm:text-sm font-black uppercase tracking-wider text-brand-dark dark:text-white group-hover:text-[#265C83] dark:group-hover:text-[#E9BD36] transition-colors duration-300">
                  ...
                  <div className="group relative py-6 flex items-start justify-between gap-6 cursor-pointer overflow-hidden transition-all duration-300">
                    ...
                    <div className="flex items-start gap-4 sm:gap-6">
                      <span className="text-[10px] font-mono font-bold text-[#265C83] dark:text-[#E9BD36] mt-1 select-none">[ 03 ]</span>
                      <div className="space-y-1">
                        <h3 className="text-xs sm:text-sm font-black uppercase tracking-wider text-brand-dark dark:text-white group-hover:text-[#265C83] dark:group-hover:text-[#E9BD36] transition-colors duration-300">
                ...
                >
                  ...
                  >
                    <img 
                      ...
                      className="w-full h-full object-cover"
                    />
                    <div className="absolute inset-0 bg-gradient-to-tr from-[#265C83]/10 to-transparent mix-blend-overlay pointer-events-none" />
                  </motion.div>
                  ...
                  <div className="absolute top-[8%] right-[8%] bg-white/95 dark:bg-[#080710]/95 backdrop-blur-md border border-brand-zinc-200 dark:border-white/10 px-3.5 py-2 rounded-xl flex items-center gap-2.5 shadow-lg select-none">
                    <span className="relative flex h-1.5 w-1.5">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#265C83] dark:bg-[#E9BD36] opacity-75" />
                      <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-[#265C83] dark:bg-[#E9BD36]" />
                    </span>
                    <span className="text-[8px] font-mono tracking-widest text-[#265C83] dark:text-[#E9BD36] font-black uppercase">
        ...
        <section className="relative overflow-hidden py-16 md:py-20 border-b border-brand-zinc-200 dark:border-white/10 bg-zinc-50/50 dark:bg-white/[0.005]">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-12 relative z-10">
            ...
            <div className="w-full bg-[#F8FAFC]/80 dark:bg-[#12121e]/40 rounded-[32px] border border-brand-zinc-200 dark:border-white/10 p-6 md:p-8 relative flex flex-col lg:flex-row gap-8 lg:gap-12 items-stretch justify-between shadow-sm">
              ...
              <div className="hidden lg:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-9 w-9 rounded-full bg-[#265C83] text-white items-center justify-center z-20 shadow-md border border-white/10">
                <ArrowRight className="h-4.5 w-4.5" />
              </div>

              {/* Card Left: Our Mission */}
              <div className="flex-1 w-full bg-white dark:bg-[#12121e] rounded-2xl border-l-4 border-l-[#265C83] border border-brand-zinc-200 dark:border-white/5 p-6 shadow-sm flex flex-col justify-between min-h-[220px] z-10 hover:border-brand-blue/30 transition-colors">
                <div className="flex gap-4 items-start">
                  ...
                  <div className="space-y-1.5 flex-1">
                    <span className="text-[10px] font-sans font-black tracking-widest text-[#265C83] uppercase block">OUR MISSION</span>
                ...
                <div className="flex items-center justify-between gap-2 px-1">
                  <div className="flex items-center gap-2">
                    <div className="h-7 w-7 rounded-full bg-[#265C83]/5 flex items-center justify-center text-[#265C83] shrink-0 border border-[#265C83]/10">
              ...
              <div className="flex-1 w-full bg-white dark:bg-[#12121e] rounded-2xl border-r-4 border-r-[#E9BD36] border border-brand-zinc-200 dark:border-white/5 p-6 shadow-sm flex flex-col justify-between min-h-[220px] z-10 hover:border-brand-blue/30 transition-colors">
                <div className="flex gap-4 items-start">
                  <div className="space-y-1.5 flex-1">
                    <span className="text-[10px] font-sans font-black tracking-widest text-[#265C83] dark:text-[#E9BD36] uppercase block">OUR VISION</span>
                    <p className="text-[11.5px] font-normal text-brand-zinc-500 leading-relaxed">
        ...
        <section className="relative overflow-hidden py-16 md:py-20 border-b border-brand-zinc-200 dark:border-white/10 bg-white dark:bg-[#080710]">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-12 relative z-10">
            ...
            <div className="text-center mb-12 flex flex-col items-center">
              <span className="text-[10px] font-sans font-black tracking-widest text-[#265C83] uppercase block mb-1">
                OUR SERVICES
              </span>
              ...
              <h2 className="font-heading text-2xl sm:text-3xl md:text-4xl font-bold text-brand-dark dark:text-white tracking-tight pt-1">
                Solutions That Drive <span className="text-[#265C83] dark:text-[#E9BD36]">Real Growth</span>
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-5">
              ...
              {/* Service Card 1 */}
              <div className="p-5 rounded-2xl glass-card-premium relative overflow-hidden group hover:border-[#265C83] dark:hover:border-[#E9BD36] flex flex-col h-[230px]">
                <div className="h-10 w-10 rounded-xl bg-[#265C83]/5 dark:bg-white/5 flex items-center justify-center text-[#265C83] dark:text-[#E9BD36] shrink-0 border border-[#265C83]/10">
                  <Palette className="h-5 w-5" />
                </div>
                <div className="h-[2px] w-4 bg-[#265C83] mt-3.5 mb-2" />
                <div className="space-y-1">
                ...
                <div className="flex justify-end pt-4.5 mt-auto">
                  <div className="h-6 w-6 rounded-full bg-zinc-100 dark:bg-white/5 flex items-center justify-center text-zinc-400 group-hover:bg-[#265C83] group-hover:text-white transition-all duration-300">
                    <ArrowRight className="h-3.5 w-3.5" />
                  </div>
                </div>
              </div>
        ...
        <section className="relative overflow-hidden py-16 md:py-20 border-b border-brand-zinc-200 dark:border-white/10 bg-zinc-50/50 dark:bg-white/[0.01]">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-12 relative z-10">
            ...
            <div className="text-center mb-12 flex flex-col items-center">
              <span className="text-[10px] font-sans font-black tracking-widest text-[#265C83] uppercase mb-1">
                // OUR PROCESS
              </span>
              <div className="h-0.5 w-6 bg-[#E9BD36] mb-3" />
              <h2 className="font-heading text-2xl sm:text-3xl md:text-4xl font-bold text-brand-dark dark:text-white tracking-tight pt-1">
                A Simple 5-Step Process That <span className="text-[#265C83] dark:text-[#E9BD36]">Delivers Results</span>
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6 md:gap-4 max-w-5xl mx-auto items-start">
              ...
              <div className="flex flex-col items-center text-center space-y-3 relative group">
                ...
                <div className="hidden md:block absolute top-6 left-[60%] w-[80%] h-1 z-0 pointer-events-none">
                  ...
                  <span className="absolute top-[-3px] left-1/2 -translate-x-1/2 h-2.5 w-2.5 rounded-full bg-[#265C83] dark:bg-[#E9BD36] shadow-sm animate-pulse" />
                </div>

                <div className="h-12 w-12 rounded-full border border-brand-zinc-200 dark:border-white/10 text-[#265C83] dark:text-[#E9BD36] flex items-center justify-center bg-white dark:bg-[#12121e] shadow-md group-hover:border-[#265C83] transition-colors duration-300 relative z-10">
                  <Search className="h-5 w-5" />
                </div>
                <div className="space-y-1.5 pt-1">
                  <span className="block text-[10px] font-sans font-black text-[#265C83] uppercase tracking-wider">01</span>
              ...
              <div className="flex flex-col items-center text-center space-y-3 relative group">
                ...
                <div className="space-y-1.5 pt-1">
                  <span className="block text-[10px] font-sans font-black text-[#265C83] uppercase tracking-wider">02</span>
              ...
              <div className="flex flex-col items-center text-center space-y-3 relative group">
                ...
                <div className="space-y-1.5 pt-1">
                  <span className="block text-[10px] font-sans font-black text-[#265C83] uppercase tracking-wider">03</span>
              ...
              <div className="flex flex-col items-center text-center space-y-3 relative group">
                ...
                <div className="space-y-1.5 pt-1">
                  <span className="block text-[10px] font-sans font-black text-[#265C83] uppercase tracking-wider">04</span>
              ...
              <div className="flex flex-col items-center text-center space-y-3 relative group">
                ...
                <div className="space-y-1.5 pt-1">
                  <span className="block text-[10px] font-sans font-black text-[#265C83] uppercase tracking-wider">05</span>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-12 relative z-10">
            ...
            <div className="text-center mb-12 flex flex-col items-center">
              ...
              <h2 className="font-heading text-2xl sm:text-3xl md:text-4xl font-bold text-brand-dark tracking-tight">
                Empowering Businesses Across <span className="text-[#265C83] dark:text-[#E9BD36]">Every Industry</span>
              </h2>
            </div>
        ...
        <section className="relative overflow-hidden py-16 md:py-24 border-b border-brand-zinc-200 dark:border-white/10 bg-zinc-50/50 dark:bg-white/[0.01]">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-12 relative z-10">
            ...
            <div className="text-center mb-16 flex flex-col items-center">
              <span className="text-[9px] font-sans font-black tracking-widest text-[#265C83] dark:text-[#E9BD36] uppercase mb-2">
                WHY BUSINESSES CHOOSE US
              </span>
              <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-black text-brand-dark tracking-tight leading-none">
                Results. Reliability. <span className="text-[#265C83] dark:text-[#E9BD36]">Relationship.</span>
              </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
              ...
              <div className="lg:col-span-4 relative flex justify-center">
                <div className="relative w-full aspect-[4/3] lg:aspect-auto lg:h-full min-h-[300px] rounded-[32px] overflow-hidden bg-[#265C83] border border-brand-zinc-200 dark:border-white/10 shadow-lg p-6 flex flex-col justify-between">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-12 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="relative aspect-[3/4] w-full max-w-[280px] rounded-[32px] overflow-hidden bg-zinc-200 dark:bg-zinc-800 border border-brand-zinc-200 dark:border-white/10 shadow-lg">
                  ...
                  <div className="absolute left-4 bottom-4 bg-white/95 dark:bg-[#12121e]/95 backdrop-blur-sm rounded-xl p-3 shadow-md border border-brand-zinc-100 dark:border-white/5 flex flex-col gap-1.5 max-w-[130px] z-10">
                    <div className="flex items-center gap-1">
                      <Users className="h-3 w-3 text-[#265C83] dark:text-[#E9BD36]" />
                  ...
                  <div className="absolute right-4 bottom-5 text-[#265C83] dark:text-[#E9BD36] font-heading font-black italic text-sm tracking-wide z-10 opacity-80 select-none">
                    Ahsan
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-5 space-y-5 text-left">
                <div className="space-y-1">
                  <span className="text-[9px] font-sans font-black tracking-widest text-[#265C83] dark:text-[#E9BD36] uppercase block">// ABOUT THE FOUNDER</span>
                ...
                <h2 className="font-heading text-3xl sm:text-4xl font-extrabold text-brand-dark tracking-tight leading-tight">
                  Hi, I'm <span className="text-[#265C83] dark:text-[#E9BD36]">Ahsan</span>
                </h2>
                <p className="text-xs sm:text-sm font-bold text-[#265C83] dark:text-[#E9BD36] tracking-wide uppercase leading-none mt-0.5">
                ...
                <div className="pt-4 flex items-center gap-6 select-none">
                  <svg className="w-32 h-12 text-[#265C83] dark:text-[#E9BD36]" viewBox="0 0 150 50" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
                    <motion.path
              ...
              <div className="lg:col-span-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="p-5 rounded-2xl bg-zinc-50/50 dark:bg-white/[0.02] border border-brand-zinc-200/80 dark:border-white/10 flex flex-col justify-between h-[120px] hover:border-brand-blue/30 transition-all duration-300">
                  <div className="flex justify-between items-start">
                    ...
                    <span className="font-heading font-black text-lg text-[#265C83] dark:text-[#E9BD36] leading-none">7+</span>
                  </div>
                  <div>
                ...
                <div className="p-5 rounded-2xl bg-zinc-50/50 dark:bg-white/[0.02] border border-brand-zinc-200/80 dark:border-white/10 flex flex-col justify-between h-[120px] hover:border-brand-blue/30 transition-all duration-300">
                  <div className="flex justify-between items-start">
                    ...
                    <span className="font-heading font-black text-lg text-[#265C83] dark:text-[#E9BD36] leading-none">300+</span>
                  </div>
                  <div>
                ...
                <div className="p-5 rounded-2xl bg-zinc-50/50 dark:bg-white/[0.02] border border-brand-zinc-200/80 dark:border-white/10 flex flex-col justify-between h-[120px] hover:border-brand-blue/30 transition-all duration-300">
                  <div className="flex justify-between items-start">
                    ...
                    <span className="font-heading font-black text-lg text-[#265C83] dark:text-[#E9BD36] leading-none">Global</span>
                  </div>
                  <div>
                ...
                <div className="p-5 rounded-2xl bg-zinc-50/50 dark:bg-white/[0.02] border border-brand-zinc-200/80 dark:border-white/10 flex flex-col justify-between h-[120px] hover:border-brand-blue/30 transition-all duration-300">
                  <div className="flex justify-between items-start">
                    ...
                    <span className="font-heading font-black text-lg text-[#265C83] dark:text-[#E9BD36] leading-none">Strategy</span>
                  </div>
                  <div>
        ...
        <section className="relative overflow-hidden py-14 md:py-20 bg-white dark:bg-[#080710]">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-12 relative z-10">
            <div className="w-full bg-[#265C83] rounded-[32px] overflow-hidden relative shadow-2xl min-h-[350px] flex items-stretch">
              ...
              <div className="hidden lg:flex flex-1 items-end justify-center relative pr-8">
                ...
                <div className="absolute bottom-8 right-0 bg-white/95 dark:bg-[#12121e]/95 backdrop-blur-sm rounded-2xl px-4 py-3.5 shadow-xl border border-white/10 flex items-start gap-3 max-w-[190px] z-20">
                  <div className="h-9 w-9 rounded-xl bg-[#265C83]/10 flex items-center justify-center shrink-0 text-[#265C83]">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-12 relative z-10">
        ...
        <div className="text-center mb-14 flex flex-col items-center">
          ...
          <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-black text-brand-dark dark:text-white tracking-tight">
            What Our <span className="text-[#265C83] dark:text-[#E9BD36]">Clients</span> Say
          </h2>
          ...
          <div className="overflow-hidden w-full">
            ...
            >
              {REVIEWS.map((r, i) => (
                ...
                >
                  <div className="relative p-6 rounded-2xl bg-white dark:bg-[#12121e] border border-brand-zinc-200/80 dark:border-white/10 shadow-sm flex flex-col justify-between hover:border-[#265C83]/30 hover:shadow-md h-full min-h-[240px] overflow-hidden">
                    ...
                    <div className="mt-6">
                      <div className="flex items-center gap-3">
                        <div
                          ...
                          style={{
                            backgroundColor: r.accent === "#E9BD36" ? "#E9BD36" : "#265C83",
                    ...
                    <div
                      ...
                      style={{ backgroundColor: r.accent === "#E9BD36" ? "#E9BD36" : "#265C83" }}
                    />
          ...
          {Array.from({ length: maxActive + 1 }).map((_, di) => (
            <button
              ...
              className={`rounded-full transition-all duration-300 ${di === safeActive
                ? "w-6 h-2.5 bg-[#265C83] dark:bg-[#E9BD36]"
                : "w-2.5 h-2.5 bg-brand-zinc-200 dark:bg-white/20 hover:bg-[#265C83]/40"
                }`}
            />
          ))}
        </div>
