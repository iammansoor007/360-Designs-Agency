        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
          ...
          >
            {posts[0] && (
              <a
                href={posts[0].link}
                className="group flex flex-col rounded-[2.5rem] border border-brand-zinc-200/80 dark:border-white/10 bg-white dark:bg-[#12121e] p-6 md:p-8 shadow-blog-card hover:shadow-blog-card-hover hover:border-brand-blue/30 dark:hover:border-brand-blue/30 transition-all duration-300 overflow-hidden card-sweep-glare select-none block"
              >
                {/* Image Wrapper */}
          ...
          >
            {posts.slice(1).map((post: any, idx: number) => (
              <a
                key={idx}
                href={post.link}
                className="group block rounded-[2rem] border border-brand-zinc-200/80 dark:border-white/10 bg-white dark:bg-[#12121e] p-4 sm:p-5 shadow-blog-card hover:shadow-blog-card-hover hover:border-brand-blue/30 dark:hover:border-brand-blue/30 transition-all duration-300 overflow-hidden card-sweep-glare select-none"
              >
