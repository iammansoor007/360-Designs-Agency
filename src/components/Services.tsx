        ...
        >
          {services.list.map((service, index) => {
            return (
              ...
              >
                <div
                  className="group relative flex flex-col justify-between rounded-[2rem] border border-brand-blue/20 dark:border-white/10 hover:border-transparent dark:hover:border-brand-blue service-card-bg p-6 xs:p-7 md:p-8 transition-all duration-500 hover:-translate-y-3 h-full min-h-[490px] sm:min-h-[520px] md:min-h-[540px] overflow-hidden shadow-blog-card hover:shadow-blog-card-hover dark:hover:shadow-[0_32px_64px_rgba(233, 189, 54,0.08)] cursor-pointer card-sweep"
                >
                  {/* Hover overlay — brand blue full fill (light theme only, remains hidden/inactive in dark theme) */}
                  <div className="absolute inset-0 bg-gradient-to-br from-brand-blue via-brand-blue to-brand-blue-dark opacity-0 group-hover:opacity-100 dark:group-hover:opacity-0 transition-opacity duration-500 z-0 rounded-[2rem]" />
