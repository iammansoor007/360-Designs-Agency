    ...
    illustration: (
      <svg className="w-full h-full text-brand-blue group-hover:text-white transition-colors duration-500" viewBox="0 0 200 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g className="animate-float-delayed" transform="translate(135, 12)">
          ...
          <text x="22.5" y="10" textAnchor="middle" fill="#FFF35C" className="group-hover:fill-brand-blue font-mono font-black" fontSize="7">RANK #1</text>
        </g>
      </svg>
    )
  },
      ...
      <svg className="w-full h-full text-brand-blue group-hover:text-white transition-colors duration-500" viewBox="0 0 200 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(25, 20)">
          ...
          <g transform="translate(15, 24)">
            ...
            <text x="7.5" y="7" textAnchor="middle" fill="currentColor" fontSize="5" fontWeight="bold">Ad</text>
        ...
        <g className="animate-float" transform="translate(115, 60)">
          ...
          <text x="32.5" y="15" textAnchor="middle" fill="currentColor" fontSize="6" fontWeight="bold" opacity="0.7">CONVERSIONS</text>
          <text x="32.5" y="28" textAnchor="middle" fill="#22c55e" fontSize="11" fontWeight="black">+380%</text>
        </g>
    ...
    illustration: (
      <svg className="w-full h-full text-brand-blue group-hover:text-white transition-colors duration-500" viewBox="0 0 200 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g className="animate-float" transform="translate(35, 10)">
          ...
          <text x="32.5" y="88.5" textAnchor="middle" fill="#FFF35C" className="group-hover:fill-brand-blue" fontSize="5.5" fontWeight="bold">SHOP NOW</text>
        </g>
        <g className="animate-float-delayed" transform="translate(110, 20)">
          ...
          <text x="32.5" y="14" textAnchor="middle" fill="currentColor" fontSize="6.5" fontWeight="bold" opacity="0.6">ROAS GOAL</text>
          <text x="32.5" y="28" textAnchor="middle" fill="#FFF35C" fontSize="11" fontWeight="black">4.8x ROAS</text>
        </g>
        <g className="animate-float-reverse" transform="translate(125, 68)">
          ...
          <text x="-12" y="17" textAnchor="middle" fill="currentColor" fontSize="12" fontWeight="black">f</text>
    ...
    illustration: (
      <svg className="w-full h-full text-brand-blue group-hover:text-white transition-colors duration-500" viewBox="0 0 200 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g className="animate-float" transform="translate(100, 35)">
          ...
          <text x="10" y="14" fill="currentColor" fontSize="6.5" fontWeight="bold">FOLLOWERS</text>
        ...
        <g transform="translate(25, 20)">
          ...
          <g transform="translate(10, 30)">
            ...
            <g transform="translate(0, 10)" fill="#FFF35C">
              ...
              <text x="25" y="3" fill="currentColor" fontSize="6.5" fontWeight="bold">4.9 (142 reviews)</text>
            </g>
            <g transform="translate(0, 24)">
              <rect width="26" height="15" rx="4" fill="#22c55e" />
              <text x="13" y="10" fill="white" fontSize="6" fontWeight="bold" textAnchor="middle">CALL</text>
              <rect x="31" width="38" height="15" rx="4" fill="currentColor" opacity="0.1" />
              <text x="50" y="10" fill="currentColor" fontSize="6" fontWeight="bold" textAnchor="middle">MAPS</text>
            </g>
          </g>
      ...
      <svg className="w-full h-full text-brand-blue group-hover:text-white transition-colors duration-500" viewBox="0 0 200 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g className="animate-float" transform="translate(100, 30)">
          ...
          <g transform="translate(56, 42)">
            ...
            <text x="0" y="3" textAnchor="middle" fill="currentColor" fontSize="8.5" fontWeight="black" fontFamily="sans-serif">100</text>
          </g>
          <text x="8" y="65" fill="#22c55e" fontSize="6.5" fontWeight="bold">PERFORMANCE</text>
        </g>
      </svg>
    )
  },
        ...
        <g transform="translate(25, 15)">
          ...
          <g transform="translate(44, 15)">
            ...
            <g className="animate-float" transform="translate(45, 10)">
              ...
              <text x="22.5" y="9.5" textAnchor="middle" fill="currentColor" fontSize="6.5" fontWeight="bold">Button</text>
            </g>
          </g>
        </g>
      ...
      <svg className="w-full h-full text-brand-blue group-hover:text-white transition-colors duration-500" viewBox="0 0 200 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(25, 15)">
          ...
          <g transform="translate(90, 15)">
            <text x="0" y="15" fill="currentColor" fontSize="12" fontWeight="black" fontFamily="serif">Aa</text>
      ...
      <svg className="w-full h-full text-brand-blue group-hover:text-white transition-colors duration-500" viewBox="0 0 200 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(25, 20)">
          ...
          <g className="animate-float-delayed" transform="translate(85, 30)">
            ...
            <text x="6" y="12" fill="currentColor" fontSize="5.5" fontWeight="bold">OPEN RATE</text>
            <text x="6" y="24" fill="#22c55e" fontSize="9" fontWeight="black">64.2%</text>
      ...
      <svg className="w-full h-full text-brand-blue group-hover:text-white transition-colors duration-500" viewBox="0 0 200 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(85, 10)" className="animate-float">
          ...
          <g transform="translate(11, 72)">
            ...
            <text x="21" y="8" fill="#FFF35C" fontSize="5" fontWeight="bold" textAnchor="middle">DOWNLOAD</text>
          </g>
        </g>
                  ...
                  <div className="relative z-10 flex flex-col h-full justify-between">
                    ...
                    <div className="flex items-center justify-between mt-6 pt-5
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-[9px] font-mono font-black text-brand-blue/40 group-hover:text-white/40 transition-colors duration-300 uppercase tracking-widest">Service</span>
