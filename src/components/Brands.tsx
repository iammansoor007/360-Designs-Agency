...
const brandLogos: Record<string, (text: string) => React.ReactNode> = {
  "Aether Tech": (text) => (
    <svg className="h-8 text-brand-zinc-400 group-hover:text-brand-blue transition-all duration-300 fill-none" viewBox="0 0 140 30" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <section id="brands" className="relative bg-gradient-to-b from-[#f8fafc] via-[#f1f5f9] to-[#f8fafc] dark:from-[#0a0a14] dark:via-[#12121e] dark:to-[#0a0a14] py-24 md:py-32 overflow-hidden border-t border-b border-brand-zinc-200/80 dark:border-white/10">
      ...
      <div className="flex flex-col gap-6 relative z-10">
        ...
        <div className="mx-auto w-[92%] max-w-5xl overflow-hidden rounded-3xl border border-brand-blue/10 dark:border-white/10 bg-white/70 dark:bg-white/5 backdrop-blur-md shadow-brands-card py-5 sm:py-6 px-4 sm:px-6 relative flex">
