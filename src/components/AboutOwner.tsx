          ...
          >
            ...
            <div className="pt-4">
              <a
                ...
                className="group relative inline-flex items-center gap-0 overflow-hidden rounded-full bg-brand-blue dark:bg-brand-yellow shadow-btn-blue active:scale-[0.97] transition-all duration-300 border border-brand-blue dark:border-brand-yellow"
              >
