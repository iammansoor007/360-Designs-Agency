        ...
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-10 lg:gap-16 items-start lg:items-center">
          ...
          <div className="w-full lg:col-span-5 flex flex-col items-center lg:items-start text-center lg:text-left gap-6">
                ...
                return (
                  <motion.button
                    ...
                    className={`inline-flex items-center gap-1.5 rounded-full border px-3 py-1.5 text-[11px] font-bold tracking-wide transition-all duration-200 cursor-pointer select-none focus:outline-none ${
                      isActive
                        ? "border-brand-blue dark:border-brand-yellow bg-[#EFF6FF] dark:bg-brand-yellow/10 text-brand-blue dark:text-brand-yellow"
                        : "border-zinc-200 dark:border-white/10 text-zinc-650 dark:text-zinc-400 hover:border-brand-blue dark:hover:border-brand-yellow hover:text-brand-blue dark:hover:text-brand-yellow"
                    }`}
              ...
              <AnimatePresence mode="wait">
                {activeHub && (() => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-brand-yellow dark:bg-brand-blue transition-colors duration-300">
                      ...
                      <span className="ml-auto shrink-0 text-[9px] font-mono font-bold tracking-widest text-brand-blue dark:text-brand-yellow uppercase whitespace-nowrap">
                        {hub.timezone}
                      </span>
                    </motion.div>
                  );
            ...
            <a
              ...
              className="group self-center lg:self-start relative inline-flex items-center gap-0 overflow-hidden rounded-full bg-brand-yellow dark:bg-brand-blue shadow-btn-blue active:scale-[0.97] transition-transform duration-150 border border-brand-yellow dark:border-brand-blue"
            >
                ...
                return (
                  ...
                  >
                    ...
                    />
                     ...
                     {/* Idle subtle pulse */}
                    <div
                      className="absolute -translate-x-1/2 -translate-y-1/2 h-5 w-5 rounded-full pointer-events-none bg-brand-blue/15 dark:bg-brand-yellow/15 animate-[ping_2s_cubic-bezier(0,0,0.2,1)_infinite]"
                    />
                    ...
                    <div
                      className={`absolute -translate-x-1/2 -translate-y-1/2 flex h-3 w-3 sm:h-3.5 sm:w-3.5 items-center justify-center rounded-full border-2 shadow-md transition-all duration-200 ${
                        isActive
                          ? "scale-150 bg-brand-yellow dark:bg-brand-blue border-brand-blue dark:border-brand-yellow"
                          : "scale-100 bg-brand-blue dark:bg-brand-yellow border-white dark:border-[#080710]"
                      }`}
                    >
                      <div
